...
module.exports = reloadCSS;
      ...
      module.exports = {};
},{"_css_loader":21}],9:[function(require,module,exports) {
'use strict';
...
var colors = ['#E3CE00', '#660200', '#18A6FF'];
...
function drawIt() {
	...
	for (var i = 0; i < particles.length; i++) {
		var dY = step / 10 * Math.sin(i * 13 + counter),
...
drawIt();
},{"./index.sass":20}],35:[function(require,module,exports) {
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket('ws://' + hostname + ':' + '65024' + '/');
...
//# sourceMappingURL=/dist/canvas_peases.map